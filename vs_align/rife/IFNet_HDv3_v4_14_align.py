...
class IFNet(nn.Module):
    ...
    def align_images(
        ...
        # subtract flow2 from flow1
        compensated_flow = flow1 - flow2

        # warp image with the new flow
    ...
    def forward(self, img0, img1, timestep=1, fastmode=True, ensemble=True, num_iterations=1, multiplier=0.5, blur_strength=0, device='cuda'):
